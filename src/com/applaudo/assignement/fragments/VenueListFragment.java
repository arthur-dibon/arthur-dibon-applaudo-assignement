...
public class VenueListFragment extends ListFragment{
	...
	public void refresh(){
		if(AppConstants.DEBUG) Log.d(TAG, "refresh");
			// Instantiate the adapter that will define the new page listener in order to load more datas
			mVenueAdapter = new VenueAdapter(getActivity(), mVenueController.getVenues());
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onItemSelected(VenueController.getInstance().getVenues().get(position).getId());
	}
